    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12 row">
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="card">
                        <div class="card-header"><?php echo e(__('List of Past returnes')); ?> </div>
                            <div class="card-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/ceo/DATA/All_Git_repo/nicn_cms/resources/views/casesReturn.blade.php ENDPATH**/ ?>