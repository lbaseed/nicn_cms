                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>    
                                            ...
                                            <tr>
                                                ...
                                                <td><b>Adjournment Date</b></td> <td><?php echo e($case->adjournment_date); ?></td>
                                            </tr><tr>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $caseStages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $caseStage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <li class="list-group-item d-flex justify-content-between align-items-start">
                                            ...
                                            <div class="font-weight-bold">[<?php echo e($caseStage->prev_stage_date); ?>]</div>
                                                Case Stage Changed from <b><?php echo e($caseStage->prev_stage); ?></b> on <b><?php echo e($caseStage->prev_stage_date); ?></b> to <b><?php echo e($caseStage->new_stage); ?></b> on <b><?php echo e($caseStage->new_stage_date); ?></b> by <i> <?php echo e($caseStage->curr_user); ?> </i>
                                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/ceo/DATA/All_Git_repo/nicn_cms/resources/views/viewCase.blade.php ENDPATH**/ ?>